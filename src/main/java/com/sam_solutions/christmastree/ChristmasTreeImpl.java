...
/**
 * User: Yahor Kastsialei Date: 12/4/14 Time: 10:56 AM
 */
public class ChristmasTreeImpl implements IChristmasTree {
	...
	public String toString() {
		...
		builder.append(reverseExcept(garlandBuilder, newLine));
	...
	private void appendSpaces(final StringBuilder garlandBuilder,
			final int space) {
		if (space == 0) {
			return;
		}
